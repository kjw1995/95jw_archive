...
## 🚀 Work Experience
### (주)티엔씨테크놀로지 (2025.11 ~)
- PG·선불전자지급 결제 플랫폼 구축 및 운영 고도화
- Spring Batch·Quartz 기반 정산·세금계산서·전표 회계연동 배치 개발
- 대외기관·원천사 연동과 연동규격서(OpenAPI) 설계·배포
- 금융감독원 실사·금융결제원 심사 대응, 개인정보 보안 처리

### 헬로핀테크 (2023.02 ~ 2025.08)
- 정산 프로세스를 MySQL 프로시저에서 Java로 전환
- 가맹점 통합 정산 배치와 백오피스 정산 관리 구축
- 정부24 연동 기반 비대면 대출 서류 제출 자동화
- MyBatis → JPA 마이그레이션 및 레거시 코드 최신화
